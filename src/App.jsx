...
export default function RicoCard() {
  ...
  const addVisitor = () => {
    ...
    const updated = [visitorInput.trim(), ...visitors].slice(0, 8);
    setVisitors(updated); setVisitorInput("");
    try { localStorage.setItem("rico_visitors", JSON.stringify(updated)); } catch {}
  };
